...
# thresholds fire:
#   Rule 1 (any remote spill -> +1)         : MEMORY_HOG     (XSMALL + big sort)
#   Rule 2 (>=20% local spill -> +1)        : LOCAL_SPILL_WH (SMALL + medium sorts)
#   Rule 3 (avg queue >=5s, n>=30 -> +1)    : SATURATED      (SMALL + 40 concurrent)
...
DEMO_SPECS: tuple[DemoWarehouseSpec, ...] = (
    DemoWarehouseSpec(
        ...
        expected_finding=(
            "Right-sizer Rule 1: remote spill detected -> upsize to SMALL"
        ),
    ),
    DemoWarehouseSpec(
